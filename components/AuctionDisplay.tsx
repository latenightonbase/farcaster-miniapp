            ...
            {topBidders.length > 0 && (
              <div className="mb-6">
                <div className="flex items-center justify-between mb-2">
                  <h3 className="text-xl font-bold text-white">Top Bidders Leaderboard</h3>
                </div>
                  ...
                  <tbody>
                    {topBidders.slice(0, 5).map((bidder, idx) => (
                      <tr key={idx} className="border-b border-white/10 flex gap-1 items-center">
                        ...
                        <td className="py-2 text-center w-[15%]">{bidder.winCount}</td>
                        <td className="py-2 text-right text-xs font-bold w-[15%]">
                          <span className={`block ${idx === 0 ? "bg-gradient-to-br from-yellow-600 to-yellow-400 via-yellow-500 bg-clip-text text-transparent" : ""}`}>
                            {bidder.totalUSDCValue.toLocaleString()}
                          </span>
                        </td>
                      </tr>
                    ))}
