    ...
    <div className="min-h-screen overflow-x-hidden bg-black animate-rise font-[var(--font-geist-mono)] ">
      <main className="relative h-full">
        ...
        <div className="relative z-1 min-h-screen">
          <ProfileSection />
          <h2 className="text-white text-2xl font-bold my-4 px-3 flex justify-start items-center gap-2">Welcome {user ? <span className="text-red-400">{user?.username.split(0,16)}{user?.username.length > 16 && "..."}</span> : <span className="w-32 h-10 bg-white/20 animate-pulse rounded-lg"></span>}</h2>
          <SponsorList />
